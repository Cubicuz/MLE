...
// berechnet den Output abhängig von input und weights
// weights bleiben hier unverändert
void activateForward(double input[], double weights[NEURONS][NEURONS],double output[]){
	//static double buffer[NEURONS];
	// insert code here
